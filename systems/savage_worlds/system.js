...
var SWCharacter = db.model('SWCharacter');
var Race = db.model('Race');
var Edge = db.model('Edge');
var ChosenHindrance = db.model('ChosenHindrance');
var ArcaneBackground = db.model('ArcaneBackground');
var Power = db.model('Power');
var HandWeapon = db.model('HandWeapon');
var RangedWeapon = db.model('RangedWeapon');
var SpecialWeapon = db.model('SpecialWeapon');
var MundaneItem = db.model('MundaneItem');
var Armor = db.model('Armor');
...
app.channel('/savage_worlds').on('connection', function (socket)
{
    ...
    socket.on('get_character', function(id, callback)
    {
        SWCharacter.find({
            ...
            include: [Race, Edge, ArcaneBackground, Power, HandWeapon, RangedWeapon, SpecialWeapon, MundaneItem, Armor, Vehicle ]
