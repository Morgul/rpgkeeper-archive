...
var db = mongoose.createConnection('mongodb://localhost/rpgkeeper');
...
db.once('open', function()
{
    ...
    // Export model
    module.exports['Permission'] = db.model('Permission', PermissionSchema);
    ...
    // Export model
    module.exports['Group'] = db.model('Group', GroupSchema);
    ...
    // Export model
    module.exports['System'] = db.model('System', SystemSchema);

    //------------------------------------------------------------------------------------------------------------------

    var BaseCharacterSchema = mongoose.Schema({
        name: String,
    ...
    // Export model
    module.exports['Character'] = db.model('BaseCharacter', BaseCharacterSchema);
