...
function buildToolbar(element, $attrs, saveCallback, cancelCallback)
{
    ...
    {
        // Lower the z-index of the current toolbar.
        this.elem.css('z-index', 10);
        this.elem.parent().css('z-index', 2);
        element.css('z-index', 10);
    ...
    {
        // Raise the z-index of the current toolbar.
        this.elem.css('z-index', 150);
        this.elem.parent().css('z-index', 148);
...
function buildToolbarElement(parent, element, toolbar)
{
    ...
    tbElem.css('top', 0);
    tbElem.css('left', 0);
    tbElem.css('z-index', '10');
    tbElem.css('display', 'none');
    tbElem.addClass('toolbar');
